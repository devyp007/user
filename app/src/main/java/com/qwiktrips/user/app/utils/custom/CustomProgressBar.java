...
public class CustomProgressBar extends View {
    ...
    private static final String DEFAULT_STROKE_COLOR = "#3F51B5";
    private static final int DEFAULT_TEXT_SIZE_SP = 60;
    private static final int DEFAULT_STROKE_WIDTH_DP = 8;
    private static final int DEFAULT_STROKE_RADIUS_DP = 9;
    ...
    private float strokeRadiusMain;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        int progressStrokeColor = Color.parseColor(DEFAULT_STROKE_COLOR);
        ...
        int progressStrokeRadius = dp2px(DEFAULT_STROKE_RADIUS_DP);
        ...
        int strokeColor = progressStrokeColor;
        int dotWidth = progressStrokeWidth;
        int strokeRadius = progressStrokeRadius;
        ...
        if (attrs != null) {
            ...
            strokeColor = a.getColor(R.styleable.CircularProgressIndicator_strokeColor, progressStrokeColor);
            dotWidth = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator_dotWidth, progressStrokeWidth);
            strokeRadius = a.getDimensionPixelSize(R.styleable.CircularProgressIndicator_strokeRadius, progressStrokeRadius);
            ...
            isStroke = a.getBoolean(R.styleable.CircularProgressIndicator_isStroke, false);
        ...
        strokePaint.setStrokeWidth(17F);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            textPaint.setTypeface(getResources().getFont(R.font.poppins_extra_bold));
        }
    ...
    private void calculateBounds(int w, int h) {
        ...
        float dotWidth = dotPaint.getStrokeWidth() + strokePaint.getStrokeWidth();
        float progressWidth = progressPaint.getStrokeWidth();
        float progressBackgroundWidth = progressBackgroundPaint.getStrokeWidth();
    ...
    private void drawStroke(Canvas canvas) {
        ...
        canvas.drawCircle(x, y, strokeRadiusMain, strokePaint);
    }
    ...
    public void setStrokeEnabled(boolean strokeEnabled) {
        if (strokeEnabled == isFillBackgroundEnabled) return;

        isStroke = strokeEnabled;

        Paint.Style style = strokeEnabled ? Paint.Style.FILL_AND_STROKE : Paint.Style.STROKE;
        progressBackgroundPaint.setStyle(style);
